<x-dynamic-component :component="$app->componentName">
   ...
   <table class="table shadow-sm border">
        ...
        <tr>
        <td>
        <a href="{{ route($app->module.'.create') }}"> <button type="submit" class="btn btn-primary"><i class="fas fa-plus text-dark m-0"></i>Add User</button></a>
        </td>
        <td>
        <div>
        <div class="mx-auto pull-right">
            <div class="">
                <form action="{{ route($app->module.'.index') }}" method="GET" role="search">
        ...
        <input type="text" class="form-control mr-2" name="item" placeholder="Search projects" id="item">
                        ...
                        <a href="{{ route($app->module.'.index') }}" class=" mt-1">
        ...
        <!-- Table -->
                ...
                <tr>
                    ...
                    <th scope="col" class="p-3">@sortablelink('firstname')</th>
                    <th scope="col" class="p-3">@sortablelink('email')</th>
